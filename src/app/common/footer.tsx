...
export const Footer = () => {
    return (
        <footer className="">
            <div className="max-h-[200px] flex justify-center bg-[url('/footer-bg.jpg')] max-h- bg-cover bg-no-repeat bg-center py-12">
            ...
            <div className="bg-[rgba(0,89,67,1)] text-[rgba(209,213,220,1)] py-14">
                <div className="w-10/12 space-y-12 mx-auto">
                    <Image
                    ...
                    height={60}
                    alt="Footer Logo"/>
                    <div className="flex justify-between items-start gap-8 font-normal text-base">
                        ...
                        <div className="max-w-[280px] divide-y-2 divide-white/20">
            ...
            <div className="flex items-center justify-between bg-[rgba(0,69,56,1)] font-normal text-[rgba(209,213,220,1)] text-sm py-6">
