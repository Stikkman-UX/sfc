...
export const Hero = () => {
    return (
        <div className="w-11/12 sm:w-10/12 max-w-[700px] lg:max-w-[800px] flex flex-col items-center gap-4 sm:gap-6 text-start sm:text-center mt-30 md:mt-48 mb-6 sm:mt-52 sm:mb-10 mx-auto">
            ...
            <div className="carousel-container-about w-full max-w-[1000px] flex items-center justify-between py-5 md:py-14 mx-auto text-white overflow-hidden">
                <div className="flex flex-col items-center md:px-16 sm:px-4 whitespace-nowrap">
                    ...
                    <span className="font-normal text-[rgba(74,74,74,0.8)] text-[12px] md:text-sm">
                        Treatment Plants
                    </span>
                </div>
