...
export const HorizontalCarousel = () => {
    ...
    useEffect(() => {
        ...
        // tl2
        // .to('.slide-container-2', { x: `-=${width1}`, duration: 1 }, '+=0.5')
        // .to('.slide-container-2', { x: `-=${width1}`, duration: 1 }, '+=0.5')
        // .to('.slide-container-2', { x: `-=${width1}`, duration: 1 }, '+=0.5')
        // .to('.slide-container-2', { x: `-=${width1}`, duration: 1 }, '+=0.5')
        // .to('.slide-container-2', { x: `-=${width1}`, duration: 1 }, '+=0.5')
    ...
    const Card = ({ id, icon, value, title, subtitle }: Card) => {
        return (
            <div className={`${ id } w-fit flex flex-col items-center gap-3 text-center text-white`}>
    ...
    const SlideContainer = ({ id }: { id: string }) => {
        return (
            <div className={`${id} w-full shrink-0 border border-blue-300 flex justify-between gap-4`}>
                <Card
                id="inactive-slide-2"
                icon={<NewsSvg1/>}
                value="25+"
