  ...
  return (
    <section className="gsap-fade-in bg-[rgba(0,89,67,1)] py-8 md:py-14">
      <div className="w-11/12 md:w-10/12 flex flex-col-reverse lg:flex-row justify-between items-stretch gap-4 md:gap-12 lg:gap-20 mx-auto">
        ...
        {/* Content: 70% */}
        <div className="flex flex-col justify-between items-start gap-10 pt-10 lg:w-[65%]">
          ...
          {/* Stats */}
          <div className="w-full flex justify-between gap-8  text-center md:text-start mx-auto lg:mx-0">
        ...
        {/* Image: 30% */}
        <div className="relative w-full h-[300px] lg:w-[35%] lg:h-auto ">
          <Image
